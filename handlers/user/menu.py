...
user_message = '✅ Aktifkan Menu Pengguna (Hanya Sendi Yang Dapat Menekan Tombol Ini, Tolong Selain Sendi Jangan Ditekan)'
...
async def admin_menu(message: Message):
    ...
    await message.answer('<b>•Menu Admin•</b>\n\n❗Menu ini Hanya Terlihat Oleh Admin BottyCu (Ganti Akun Untuk Melihat Menu Pengguna)', reply_markup=markup)
